...
#         -Uri $saveImagePath 
#        | Where-Object -Property PackageAlias -eq -Value $savePackageAlias
      
#        $package = Az.DesktopVirtualization\New-AzWvdMsixPackage 
#        -HostPoolName $saveHostPoolName `
#         -ResourceGroupName  $saveResourceGroupName `
#         -SubscriptionId  $saveSubscriptionId `
...
#        -DisplayName  $extractPackage.DisplayName `
#        -IsRegularRegistration  $extractPackage.IsRegularRegistration `
#        -IsActive  $extractPackage.IsActive

   
# $v1= $package.ImagePath
# $v2= $package.PackageRelativePath

# Write-Output $savePackageAlias "@" $v1 "@" $v2 "@" $package.PackageFullName
# }
# }